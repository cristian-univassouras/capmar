  ...
  return (
    <>
      ...
      <div className="flex-1 overflow-hidden px-4 pt-4 pb-20 relative">
        ...
        >
          ...
          <div className="w-full h-40 rounded-xl bg-linear-to-br from-indigo-500/20 to-purple-800/20 border border-white/5 flex items-center justify-center overflow-hidden mb-4 relative group cursor-pointer">
             ...
             <div className="relative z-10 w-12 h-12 rounded-full bg-[#333333] flex items-center justify-center">
      ...
      <motion.div 
        ...
        className="absolute bottom-0 w-full h-16 bg-[#111111] border-t border-gray-800 flex items-center justify-around px-2 z-20 pb-2"
      >
...
function useWindowDimensions() {
  const [dim, setDim] = useState({ width: 1920, height: 1080 }); // Default for SSR
  useEffect(() => {
...
export default function PhoneSection({ children }: { children?: ReactNode }) {
  ...
  return (
    ...
    >
      ...
      {/* Children flow normally after the track ends */}
      {children && (
